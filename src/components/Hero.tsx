  ...
  return (
    <section id="home" className="border-b border-[var(--line)] bg-white px-5 pb-20 pt-36 sm:px-8 sm:pb-24 sm:pt-44">
      <div className="mx-auto max-w-7xl">
        ...
        <div className="mt-10 flex flex-wrap gap-3"><a href="#projects" className="rounded-lg bg-[var(--accent)] px-6 py-3.5 text-sm font-bold text-white hover:bg-[var(--accent-dark)]">프로젝트 보기</a><a href={profile.resumeUrl} className="rounded-lg border border-[var(--line-strong)] bg-white px-6 py-3.5 text-sm font-bold hover:bg-[var(--bg)]">이력서 다운로드</a></div>
